...
class SiteCheckoutController extends Controller
{
        ...
        try {
            Mail::send(
                ...
                function ($send_email) use ($user) {
                    $send_email->subject('ShopVL - Xác nhận đơn hàng');
    ...
    public function momo_payment(Request $request)
    {
        ...
        $orderId = time() . "";
        $redirectUrl = "http://localhost/tavinhloc-2121110013-laravel/public/thanh-toan-thanh-cong/" . $request->code;
        $ipnUrl = "http://localhost/tavinhloc-2121110013-laravel/public/thanh-toan-thanh-cong/" . $request->code;
        $extraData = "";
    ...
    public function vnpay_payment(Request $request)
    {
        ...
        $vnp_Returnurl = "http://localhost/tavinhloc-2121110013-laravel/public/thanh-toan-thanh-cong/" . $request->code;
