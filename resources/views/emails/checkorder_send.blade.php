...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td>{{ number_format($total_price +22000) }}  VND gồm( 22000 VND phí vận chuyển )</td>
        </tr>
        <tr>
    ...
    <div style="text-align: center">
        <a  href="{{ route('site.orderaccept',['id'=>$order->id,'accept_token'=>$order->accept_token]) }}" style="font-size: medium; display: inline-block; background-color: blue; color: white; padding: 7px 25px; font-weight: bold;">Xác nhận ngay</a>
    </div>
