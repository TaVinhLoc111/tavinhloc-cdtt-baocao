            ...
            <div class="navbar  " id="navbar">
                <div class="header-main  d-md-block d-none container ">
                    <div class="header-inner  d-flex  justify-content-between align-items-center">
                        <div class="logo mr-5">
                            <img style="width: 70px; height:70px" src="{{ asset('images/logo_web2.jpg') }}" alt="logo_web.jpg">
                        </div>
                        <!-- <div class="search align-self-center mr-3 ">
                            <form class="search-form" action="">
                                <input type="text" name="q" placeholder="Tìm kiếm thú cưng bạn muốn mua:...">
                        ...
                        <div class="infor align-self-center">
                            ...
                            <li class="infor-item heart-icon-box heart-far">
                                <a href="{{ route('account.wishlist') }}">
                                    Yêu thích <i class="fas fa-heart fs-2"></i>
                             ...
                             @endphp
                                ...
                                <li class="infor-item heart-icon-box heart-far">
                                    <a href="{{ route('temp.wishlist') }}">
                                        Sản phẩm được yêu thích<i class="fa-solid fa-heart fs-2">
                                ...
                                <li class="infor-item heart-far">
                                <a href="{{ route('site.cart') }}">
                                    Giỏ hàng <i class="fas fa-shopping-cart fs-3 me-1"></i>
                                </a>
                            ...
                            <ul class="m-0 d-flex align-items-center heart-far">
                                ...
                                <li class="infor-item heart-far">
                                    <a href="{{ route('site.cart') }}">
                                       ...
                                       <i class="fa-solid fa-cart-shopping fs-3 me-1">
                                        </i>
                                    </a>
